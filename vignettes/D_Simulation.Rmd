...
Show the default gene_map from the CCDS.current.txt file. Here the model will show the default gene list from the file. If you need to change the gene list change/define the gene "CCDS_ID" in the file.
...
Also get VAF data and save them into file 'Output/VAF_data.txt':
            ...
            pck.env$VAF  =  get_rho_VAF( vf = pck.env$vf, 
