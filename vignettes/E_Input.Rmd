...
| **ls_genes    **  | The list of genes used in the simulation | must be string |
...
The list of genes is defined in the parameter file as **ls_genes** parameter
(list of genes should be string with genes divided by comma like
"CCDS4107.1, CCDS8702.1, CCDS43171.1, CCDS11118.1" ). 
