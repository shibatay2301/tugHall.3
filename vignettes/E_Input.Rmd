...
| **censor_cells_number = 30000 **     | Max cell number where the program forcibly stops  | number of cells |
| **censor_time_step = 200**        | Max time where the program forcibly stops  | in time-steps |
